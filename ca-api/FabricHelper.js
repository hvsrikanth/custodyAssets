...
// var channel = fabric_client.newChannel('tradingchannel');
// var order = fabric_client.newOrderer('grpc://localhost:2050')
...
// // Request LC by Buyer
function onboardInvestor(req, res) {
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	var request = {chaincodeId: 'cc1',
		fcn: 'onboard_investor',
		args: [req.body.userName, req.body.userFName, req.body.userLName, req.body.userIdentity, req.body.kycStatus, req.body.depositoryAC, req.body.bankAC],
		chainId: 'tradingchannel',
		txId: tx_id};
	...
	if (isProposalGood) {
		...
		event_hub.setPeerAddr('grpc://localhost:5053');
...
function acceptLC(req, res) {
	...
	// setup the fabric network
	var channel = fabric_client.newChannel('cc1');
	var order = fabric_client.newOrderer('grpc://localhost:2050')
	channel.addOrderer(order);
...
let tfbc = {
	onboardInvestor: onboardInvestor,
	issueLC: issueLC,
	acceptLC: acceptLC,
	getLC: getLC,
